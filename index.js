...
const adicionarParticipante =(event)=>{
  ...
  const dodosDoFormulario = new FormData(event.target)
  ...
  //verificar se o participante já possui cadastro
...
const fazerCheckIn=(event)=>{
  //confirmar se o participante realmente quer fazer o check-in
  ...
  participante.dataCheckIn = new Data()
  //atualizar a lista de participantes
  atualizarLista(participantes)
  //limpar formulário
   evento.target.querySelector('[nome="nome"]').value=""
  evento.target.querySelector('[nome="email"]').value=""
